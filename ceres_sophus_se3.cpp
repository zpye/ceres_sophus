...
bool test(Sophus::SE3d const& T_w_targ, Sophus::SE3d const& T_w_init) {
  ...
  //problem.AddParameterBlock(T_wr.data(), Sophus::SE3d::num_parameters, LocalParamSE3);
  problem.AddParameterBlock(T_wr.data(), Sophus::SE3d::num_parameters, Sophus::GetLocalParamsSE3());
